...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW50aG9ueS1iIiwiYSI6ImNrc2ltbDNpczB0bTkzMW1icmx0amFvdXUifQ.eb_P9T8qkYC33gjWnHa7gQ';
...
},{}],"signin.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status == 'success') {
              (0, _alert.showAlert)('success', 'Logged in successfully'); // document.cookie = `jwt=${result.data.token}`;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"update-settings.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: type === 'data' ? 'http://localhost:3000/api/v1/users/update-me' : ' http://localhost:3000/api/v1/users/update-password',
              data: data
            });
          ...
          case 3:
            ...
            if (result.data.status == 'success') {
              (0, _alert.showAlert)('success', 'Settings changed successfully');
            }
...
var stripe = Stripe('pk_test_51JSgNVAWSpZmKltnhewMsYZhLZpwl4VmadZ6rtrX2oKced8JqDPOnd8wfBw3hG6BL2BBkMEqCSYrifsvDBdlMzkx00A5s9mC8J');
...
if (logOutButton) {
  ...
  logOutButton.addEventListener('click', _signin.logout);
}
...
if (changeSettingsForm) {
  changeSettingsForm.addEventListener('submit', function (e) {
    ...
    console.log(form); // let data = { form, name };
...
if (changePasswordForm) {
  changePasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var currentPassword, newPassword, confirmNewPassword, data;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              currentPassword = document.getElementsByClassName('current-password')[0].value;
              newPassword = document.getElementsByClassName('new-password')[0].value;
              confirmNewPassword = document.getElementsByClassName('confirm-new-password')[0].value;
              data = {
